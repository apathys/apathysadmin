var site_cityUtil = function () {
    var s, o, u = {},
        ...
        f = function f(e, t) {
            ...
            return $.ajax({
                ...
                async: !1,
                success: function i(e) {
                    (e = $.parseJSON(e)).success && ($.each(e.cityInfoList,
                        function (e, n) {
        ...
        g = function g(n, e, t) {
            ...
            var r = undefined;
            return i[n] && (r = i[n][2]),
                r && (0 == r.length ? "street" == t && (r = undefined) : "cityOrCounty" == t && 6 < r[0].id.length && (r = undefined)),
                r || $.ajax({
                    url: Site.addRequestPrefix({
                        newPath: "/ajax",
                        oldPath: "../ajax"
                    ...
                    success: function c(e) {
                        (e = $.parseJSON(e)).success ? (r = e.childList, i[n] && (i[n][2] = r), $.each(r,
                            function (e, n) {
                                var t = [];
                                t.push(n.name),
                                    t.push(n.parentid),
        ...
        d = function d(e, n) {
            ...
            i.length || $.ajax({
                ...
                success: function l(e) {
                    if ((e = $.parseJSON(e)).success) for (var n = 0,
                        t = e.provinceInfoList.length; n < t; n++) i.push(e.provinceInfoList[n])
                }
            });
            try {
                var r = h[e][1],
        ...
        t = function t(e) {
            return "string" != typeof e && (e += ""),
                "" != u[e] && "undefined" != u[e] && null != u[e] || f(new Array(e), 2052),
                !(!u[e] || "1" !== u[e][1])
        },
        y = function y(e, n) {
        ...
        A = function A(e) {
            if (e) return "Special Administrative Region" == e.slice(e.length - 29, e.length) && (e = e.slice(0, e.length - 30)),
                "Autonomous Region" == e.slice(e.length - 17, e.length) && (e = e.slice(0, e.length - 18)),
                "Province" != e.slice(e.length - 8, e.length) && "province" != e.slice(e.length - 8, e.length) || (e = e.slice(0, e.length - 9)),
                "Zhuang" == e.slice(e.length - 6, e.length) && (e = e.slice(0, e.length - 7)),
                "Uygur" == e.slice(e.length - 5, e.length) && (e = e.slice(0, e.length - 6)),
                "Hui" == e.slice(e.length - 3, e.length) && (e = e.slice(0, e.length - 4)),
                e
        },
        L = function L(e) {
            if (e) return "Tibetan Autonomous Prefecture" == e.slice(e.length - 29, e.length) && (e = e.slice(0, e.length - 30)),
                "Li and Miao Autonomous" == e.slice(e.length - 22, e.length) && (e = e.slice(0, e.length - 23)),
                "Li Autonomous" == e.slice(e.length - 13, e.length) && (e = e.slice(0, e.length - 14)),
                "Prefecture" == e.slice(e.length - 10, e.length) && (e = e.slice(0, e.length - 11)),
                "Mongolian" == e.slice(e.length - 9, e.length) && (e = e.slice(0, e.length - 10)),
                "County" == e.slice(e.length - 6, e.length) && (e = e.slice(0, e.length - 7)),
                "City" == e.slice(e.length - 4, e.length) && (e = e.slice(0, e.length - 5)),
                e
        },
        x = function x(e, i) {
            var n = [],
                r = [];
            return n = 2052 == e || 1028 == e ? u : a,
                $.each(n,
                    function (e, n) {
                        var t = {};
    ...
    return {
        ...
        simpleCityListStr: function z(e) {
            ...
            $.each(i,
                function (e, n) {
                    O(2052, e) == n.count ? (t.push(P(I(e).name)), t.push("、")) : $.each(n.objs,
                        function (e, n) {
                            r.push(p(n.name)),
                                r.push("、")
                        })
