...
{
    public class ImpBaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : XxsEntity
    { 
        public readonly  EFDataContext Context;

        public ImpBaseRepository(EFDataContext _EFDbContext) {
            Context = _EFDbContext;
        }
